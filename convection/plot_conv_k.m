...
if strcmp(wall, 'rigid')
    path1 = ['_N=',num2str(N),'nc=',num2str(nc),'nkx=',num2str(nkx),'nkz=',num2str(nkz),'_R=',num2str(R),eddy,'kplus'];
    
else
    Cm = 0.46; Ck = 181; Cd=0.091;
    path1 = ['_N=',num2str(N),'nc=',num2str(nc),'nkx=',num2str(nkx),'nkz=',num2str(nkz),'_R=',num2str(R),'_Cm=',num2str(Cm),'_Ck=',num2str(Ck),'_Cd=',num2str(Cd),eddy,'kplus-50'];
end
...
kxVector = logspace(-5,0,nkx).*R;
kzVector = logspace(-5,0,nkz).*R;
